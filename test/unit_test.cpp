...
// ============================================================================
// process_dns_packet - RDATA hexdump fallback (format_rdata / decode_txt)
// ============================================================================
//
// Tins::DNS::resource::data() only formats RDATA as text for types it
// understands (address, decompressed name, or TXT-like text); anything
// else comes back as raw wire bytes. format_rdata() hex-encodes those
// (prefixed "0x") instead of letting raw binary reach the log line, and
// decode_txt() strips TXT's RFC 1035 character-string length prefix(es)
// first, since without that a single leading length byte would make an
// otherwise-clean TXT string get hex-encoded too.

static const std::vector<uint8_t> PKT_NS = {
    0x45, 0x00, 0x00, 0x4b, 0x00, 0x00, 0x40, 0x00, 0x40, 0x11, 0x00, 0x00,
    0xac, 0x1f, 0x35, 0x7b, 0xac, 0x1f, 0x35, 0x01, 0x00, 0x35, 0x30, 0x39,
    0x00, 0x37, 0x00, 0x00, 0x12, 0x34, 0x81, 0x80, 0x00, 0x01, 0x00, 0x01,
    0x00, 0x00, 0x00, 0x00, 0x07, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65,
    0x03, 0x63, 0x6f, 0x6d, 0x00, 0x00, 0x01, 0x00, 0x01, 0xc0, 0x0c, 0x00,
    0x02, 0x00, 0x01, 0x00, 0x00, 0x00, 0x3c, 0x00, 0x06, 0x03, 0x6e, 0x73,
    0x31, 0xc0, 0x0c,
};
static const std::vector<uint8_t> PKT_DNAME = {
    0x45, 0x00, 0x00, 0x52, 0x00, 0x00, 0x40, 0x00, 0x40, 0x11, 0x00, 0x00,
    0xac, 0x1f, 0x35, 0x7b, 0xac, 0x1f, 0x35, 0x01, 0x00, 0x35, 0x30, 0x39,
    0x00, 0x3e, 0x00, 0x00, 0x12, 0x34, 0x81, 0x80, 0x00, 0x01, 0x00, 0x01,
    0x00, 0x00, 0x00, 0x00, 0x07, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65,
    0x03, 0x63, 0x6f, 0x6d, 0x00, 0x00, 0x01, 0x00, 0x01, 0xc0, 0x0c, 0x00,
    0x27, 0x00, 0x01, 0x00, 0x00, 0x00, 0x3c, 0x00, 0x0d, 0x07, 0x65, 0x78,
    0x61, 0x6d, 0x70, 0x6c, 0x65, 0x03, 0x6e, 0x65, 0x74, 0x00,
};
static const std::vector<uint8_t> PKT_SOA = {
    0x45, 0x00, 0x00, 0x6c, 0x00, 0x00, 0x40, 0x00, 0x40, 0x11, 0x00, 0x00,
    0xac, 0x1f, 0x35, 0x7b, 0xac, 0x1f, 0x35, 0x01, 0x00, 0x35, 0x30, 0x39,
    0x00, 0x58, 0x00, 0x00, 0x12, 0x34, 0x81, 0x80, 0x00, 0x01, 0x00, 0x01,
    0x00, 0x00, 0x00, 0x00, 0x07, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65,
    0x03, 0x63, 0x6f, 0x6d, 0x00, 0x00, 0x01, 0x00, 0x01, 0xc0, 0x0c, 0x00,
    0x06, 0x00, 0x01, 0x00, 0x00, 0x00, 0x3c, 0x00, 0x27, 0x03, 0x6e, 0x73,
    0x31, 0xc0, 0x0c, 0x0a, 0x68, 0x6f, 0x73, 0x74, 0x6d, 0x61, 0x73, 0x74,
    0x65, 0x72, 0xc0, 0x0c, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x0e, 0x10,
    0x00, 0x00, 0x07, 0x08, 0x00, 0x09, 0x3a, 0x80, 0x00, 0x00, 0x00, 0x3c,
};
static const std::vector<uint8_t> PKT_SRV = {
    0x45, 0x00, 0x00, 0x5b, 0x00, 0x00, 0x40, 0x00, 0x40, 0x11, 0x00, 0x00,
    0xac, 0x1f, 0x35, 0x7b, 0xac, 0x1f, 0x35, 0x01, 0x00, 0x35, 0x30, 0x39,
    0x00, 0x47, 0x00, 0x00, 0x12, 0x34, 0x81, 0x80, 0x00, 0x01, 0x00, 0x01,
    0x00, 0x00, 0x00, 0x00, 0x07, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65,
    0x03, 0x63, 0x6f, 0x6d, 0x00, 0x00, 0x01, 0x00, 0x01, 0x04, 0x5f, 0x73,
    0x69, 0x70, 0x04, 0x5f, 0x74, 0x63, 0x70, 0xc0, 0x0c, 0x00, 0x21, 0x00,
    0x01, 0x00, 0x00, 0x00, 0x3c, 0x00, 0x0c, 0x00, 0x0a, 0x00, 0x14, 0x13,
    0xc4, 0x03, 0x73, 0x69, 0x70, 0xc0, 0x0c,
};
static const std::vector<uint8_t> PKT_DNSKEY = {
    0x45, 0x00, 0x00, 0x4d, 0x00, 0x00, 0x40, 0x00, 0x40, 0x11, 0x00, 0x00,
    0xac, 0x1f, 0x35, 0x7b, 0xac, 0x1f, 0x35, 0x01, 0x00, 0x35, 0x30, 0x39,
    0x00, 0x39, 0x00, 0x00, 0x12, 0x34, 0x81, 0x80, 0x00, 0x01, 0x00, 0x01,
    0x00, 0x00, 0x00, 0x00, 0x07, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65,
    0x03, 0x63, 0x6f, 0x6d, 0x00, 0x00, 0x01, 0x00, 0x01, 0xc0, 0x0c, 0x00,
    0x30, 0x00, 0x01, 0x00, 0x00, 0x00, 0x3c, 0x00, 0x08, 0x01, 0x00, 0x03,
    0x08, 0xaa, 0xbb, 0xcc, 0xdd,
};
static const std::vector<uint8_t> PKT_NSEC3PARAM = {
    0x45, 0x00, 0x00, 0x4c, 0x00, 0x00, 0x40, 0x00, 0x40, 0x11, 0x00, 0x00,
    0xac, 0x1f, 0x35, 0x7b, 0xac, 0x1f, 0x35, 0x01, 0x00, 0x35, 0x30, 0x39,
    0x00, 0x38, 0x00, 0x00, 0x12, 0x34, 0x81, 0x80, 0x00, 0x01, 0x00, 0x01,
    0x00, 0x00, 0x00, 0x00, 0x07, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65,
    0x03, 0x63, 0x6f, 0x6d, 0x00, 0x00, 0x01, 0x00, 0x01, 0xc0, 0x0c, 0x00,
    0x33, 0x00, 0x01, 0x00, 0x00, 0x00, 0x3c, 0x00, 0x07, 0x01, 0x00, 0x00,
    0x0a, 0x02, 0x12, 0x34,
};
static const std::vector<uint8_t> PKT_NSAP_PTR = {
    0x45, 0x00, 0x00, 0x4b, 0x00, 0x00, 0x40, 0x00, 0x40, 0x11, 0x00, 0x00,
    0xac, 0x1f, 0x35, 0x7b, 0xac, 0x1f, 0x35, 0x01, 0x00, 0x35, 0x30, 0x39,
    0x00, 0x37, 0x00, 0x00, 0x12, 0x34, 0x81, 0x80, 0x00, 0x01, 0x00, 0x01,
    0x00, 0x00, 0x00, 0x00, 0x07, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65,
    0x03, 0x63, 0x6f, 0x6d, 0x00, 0x00, 0x01, 0x00, 0x01, 0xc0, 0x0c, 0x00,
    0x17, 0x00, 0x01, 0x00, 0x00, 0x00, 0x3c, 0x00, 0x06, 0x03, 0x70, 0x74,
    0x72, 0xc0, 0x0c,
};
static const std::vector<uint8_t> PKT_CERT = {
    0x45, 0x00, 0x00, 0x4e, 0x00, 0x00, 0x40, 0x00, 0x40, 0x11, 0x00, 0x00,
    0xac, 0x1f, 0x35, 0x7b, 0xac, 0x1f, 0x35, 0x01, 0x00, 0x35, 0x30, 0x39,
    0x00, 0x3a, 0x00, 0x00, 0x12, 0x34, 0x81, 0x80, 0x00, 0x01, 0x00, 0x01,
    0x00, 0x00, 0x00, 0x00, 0x07, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65,
    0x03, 0x63, 0x6f, 0x6d, 0x00, 0x00, 0x01, 0x00, 0x01, 0xc0, 0x0c, 0x00,
    0x25, 0x00, 0x01, 0x00, 0x00, 0x00, 0x3c, 0x00, 0x09, 0x00, 0x01, 0x30,
    0x39, 0x08, 0x01, 0x02, 0x03, 0x04,
};
static const std::vector<uint8_t> PKT_TXT_SINGLE = {
    0x45, 0x00, 0x00, 0x52, 0x00, 0x00, 0x40, 0x00, 0x40, 0x11, 0x00, 0x00,
    0xac, 0x1f, 0x35, 0x7b, 0xac, 0x1f, 0x35, 0x01, 0x00, 0x35, 0x30, 0x39,
    0x00, 0x3e, 0x00, 0x00, 0x12, 0x34, 0x81, 0x80, 0x00, 0x01, 0x00, 0x01,
    0x00, 0x00, 0x00, 0x00, 0x07, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65,
    0x03, 0x63, 0x6f, 0x6d, 0x00, 0x00, 0x10, 0x00, 0x01, 0xc0, 0x0c, 0x00,
    0x10, 0x00, 0x01, 0x00, 0x00, 0x00, 0x3c, 0x00, 0x0d, 0x0c, 0x45, 0x78,
    0x61, 0x6d, 0x70, 0x6c, 0x65, 0x20, 0x74, 0x65, 0x78, 0x74,
};
static const std::vector<uint8_t> PKT_TXT_MULTI = {
    0x45, 0x00, 0x00, 0x60, 0x00, 0x00, 0x40, 0x00, 0x40, 0x11, 0x00, 0x00,
    0xac, 0x1f, 0x35, 0x7b, 0xac, 0x1f, 0x35, 0x01, 0x00, 0x35, 0x30, 0x39,
    0x00, 0x4c, 0x00, 0x00, 0x12, 0x34, 0x81, 0x80, 0x00, 0x01, 0x00, 0x01,
    0x00, 0x00, 0x00, 0x00, 0x07, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65,
    0x03, 0x63, 0x6f, 0x6d, 0x00, 0x00, 0x10, 0x00, 0x01, 0xc0, 0x0c, 0x00,
    0x10, 0x00, 0x01, 0x00, 0x00, 0x00, 0x3c, 0x00, 0x1b, 0x06, 0x76, 0x3d,
    0x73, 0x70, 0x66, 0x31, 0x13, 0x69, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65,
    0x3a, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2e, 0x6e, 0x65, 0x74,
};
static const std::vector<uint8_t> PKT_TXT_MALFORMED = {
    0x45, 0x00, 0x00, 0x4b, 0x00, 0x00, 0x40, 0x00, 0x40, 0x11, 0x00, 0x00,
    0xac, 0x1f, 0x35, 0x7b, 0xac, 0x1f, 0x35, 0x01, 0x00, 0x35, 0x30, 0x39,
    0x00, 0x37, 0x00, 0x00, 0x12, 0x34, 0x81, 0x80, 0x00, 0x01, 0x00, 0x01,
    0x00, 0x00, 0x00, 0x00, 0x07, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65,
    0x03, 0x63, 0x6f, 0x6d, 0x00, 0x00, 0x10, 0x00, 0x01, 0xc0, 0x0c, 0x00,
    0x10, 0x00, 0x01, 0x00, 0x00, 0x00, 0x3c, 0x00, 0x06, 0xc8, 0x73, 0x68,
    0x6f, 0x72, 0x74,
};

TEST_CASE("process_dns_packet - NS reply stays a decompressed name, not hex") {
    reset_config();
    reset_stats();
    clear_qtypes();
    enable_qtypes("NS");
    ...
    process_dns_packet(PKT_NS.data(), (int)PKT_NS.size(), *logger);

    CHECK(packet_stats.logged_records == 1);
    const std::string output = oss.str();
    CHECK(output.find("NS example.com -> ns1.example.com") != std::string::npos);
    CHECK(output.find("0x") == std::string::npos);

    reset_config();
}

TEST_CASE("process_dns_packet - DNAME reply stays a decompressed name, not hex") {
    reset_config();
    reset_stats();
    clear_qtypes();
    enable_qtypes("DNAME");
    ...
    process_dns_packet(PKT_DNAME.data(), (int)PKT_DNAME.size(), *logger);

    CHECK(packet_stats.logged_records == 1);
    const std::string output = oss.str();
    CHECK(output.find("DNAME example.com -> example.net") != std::string::npos);
    CHECK(output.find("0x") == std::string::npos);

    reset_config();
}

TEST_CASE("process_dns_packet - SOA RDATA libtins does not format is hex-encoded") {
    reset_config();
    reset_stats();
    clear_qtypes();
    enable_qtypes("SOA");
    ...
    process_dns_packet(PKT_SOA.data(), (int)PKT_SOA.size(), *logger);

    CHECK(packet_stats.logged_records == 1);
    CHECK(oss.str().find(
        "SOA example.com -> "
        "0x036e7331076578616d706c6503636f6d000a686f73746d6173746572"
        "076578616d706c6503636f6d000000000100000e100000070800093a800000003c"
    ) != std::string::npos);

    reset_config();
}

TEST_CASE("process_dns_packet - SRV RDATA libtins does not format is hex-encoded") {
    reset_config();
    reset_stats();
    clear_qtypes();
    enable_qtypes("SRV");
    ...
    process_dns_packet(PKT_SRV.data(), (int)PKT_SRV.size(), *logger);

    CHECK(packet_stats.logged_records == 1);
    CHECK(oss.str().find("SRV _sip._tcp.example.com -> 0x000a001413c403736970c00c")
          != std::string::npos);

    reset_config();
}

TEST_CASE("process_dns_packet - DNSKEY RDATA is hex-encoded") {
    reset_config();
    reset_stats();
    clear_qtypes();
    ...
    CHECK(packet_stats.logged_records == 1);
    CHECK(oss.str().find("DNSKEY example.com -> 0x01000308aabbccdd") != std::string::npos);

    reset_config();
}

TEST_CASE("process_dns_packet - NSEC3PARAM RDATA is hex-encoded") {
    reset_config();
    reset_stats();
    clear_qtypes();
    enable_qtypes("NSEC3PARAM");
    std::ostringstream oss;
    auto logger = make_test_logger(oss);

    process_dns_packet(PKT_NSEC3PARAM.data(), (int)PKT_NSEC3PARAM.size(), *logger);

    CHECK(packet_stats.logged_records == 1);
    CHECK(oss.str().find("NSEC3PARAM example.com -> 0x0100000a021234") != std::string::npos);

    reset_config();
}

TEST_CASE("process_dns_packet - CERT RDATA is hex-encoded") {
    reset_config();
    reset_stats();
    clear_qtypes();
    enable_qtypes("CERT");
    ...
    process_dns_packet(PKT_CERT.data(), (int)PKT_CERT.size(), *logger);

    CHECK(packet_stats.logged_records == 1);
    CHECK(oss.str().find("CERT example.com -> 0x000130390801020304") != std::string::npos);

    reset_config();
}

TEST_CASE("process_dns_packet - NSAP-PTR name-shaped RDATA is hex, not decompressed") {
    // Unlike PTR/NS/CNAME/DNAME, libtins does not decompress NSAP-PTR's
    // name-shaped RDATA, so it falls back to hex like any other
    // unformatted type instead of showing "ptr.example.com". Known
    // limitation, not something format_rdata() attempts to fix.
    reset_config();
    reset_stats();
    clear_qtypes();
    enable_qtypes("NSAP-PTR");
    std::ostringstream oss;
    auto logger = make_test_logger(oss);

    process_dns_packet(PKT_NSAP_PTR.data(), (int)PKT_NSAP_PTR.size(), *logger);

    CHECK(packet_stats.logged_records == 1);
    CHECK(oss.str().find("NSAP-PTR example.com -> 0x03707472c00c") != std::string::npos);

    reset_config();
}

TEST_CASE("process_dns_packet - single-string TXT drops its length-prefix byte") {
    reset_config();
    reset_stats();
    clear_qtypes();
    enable_qtypes("TXT");
    ...
    process_dns_packet(PKT_TXT_SINGLE.data(), (int)PKT_TXT_SINGLE.size(), *logger);

    CHECK(packet_stats.logged_records == 1);
    CHECK(oss.str().find("TXT example.com -> Example text") != std::string::npos);

    reset_config();
}

TEST_CASE("process_dns_packet - multi-string TXT is joined with a space") {
    reset_config();
    reset_stats();
    clear_qtypes();
    enable_qtypes("TXT");
    ...
    process_dns_packet(PKT_TXT_MULTI.data(), (int)PKT_TXT_MULTI.size(), *logger);

    CHECK(packet_stats.logged_records == 1);
    CHECK(oss.str().find("TXT example.com -> v=spf1 include:example.net") != std::string::npos);

    reset_config();
}

TEST_CASE("process_dns_packet - malformed TXT length prefix falls back to safe hex") {
    // The character-string length byte (200) claims more bytes than the
    // RDATA actually contains; decode_txt() must detect that rather than
    ...
    process_dns_packet(PKT_TXT_MALFORMED.data(), (int)PKT_TXT_MALFORMED.size(), *logger);

    CHECK(packet_stats.logged_records == 1);
    CHECK(oss.str().find("TXT example.com -> 0xc873686f7274") != std::string::npos);
